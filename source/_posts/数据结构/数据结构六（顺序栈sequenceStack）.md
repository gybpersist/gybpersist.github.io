...
#sticky: 5              #置顶 越大越优先
cover: /img/封面/数据结构/cover (5).png   # 文章封面
---
## 前言
 ...
 ![顺序栈](../img/文章/数据结构/数据结构六（顺序栈sequenceStack）/顺序栈.jpg "顺序栈")
...
##  入栈(sqStack_Push)
 ...
 ![入栈](../img/文章/数据结构/数据结构六（顺序栈sequenceStack）/入栈.png "入栈")
...
##  出栈（sqStack_Pop）
 ...
 ![出栈](../img/文章/数据结构/数据结构六（顺序栈sequenceStack）/出栈.png "出栈")
