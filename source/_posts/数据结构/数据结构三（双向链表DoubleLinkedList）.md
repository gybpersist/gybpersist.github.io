...
#sticky: 8              #置顶 越大越优先
cover: /img/封面/数据结构/cover (2).png   # 文章封面
---
##  前言
 ...
 ——遍历双向链表
  ...
  ![双向链表](../img/文章/数据结构/数据结构三（双向链表DoubleLinkedList）/双向链表.png "双向链表")
...
##  头插（DoubleLList_HeadInsert）
  ...
  ![头插](../img/文章/数据结构/数据结构三（双向链表DoubleLinkedList）/头插.png "头插")
...
##  尾插（DoubleLList_TailInsert）
  ...
  ![尾插](../img/文章/数据结构/数据结构三（双向链表DoubleLinkedList）/尾插.png "尾插")
...
##  指定插入（DoubleLList_DestInsert）
  ...
  ![指定插入](../img/文章/数据结构/数据结构三（双向链表DoubleLinkedList）/指定插入.png "指定插入")
...
##  头删 删除首结点（DoubleLList_HeadDel）
  ...
  ![头删](../img/文章/数据结构/数据结构三（双向链表DoubleLinkedList）/头删.png "头删")
...
##  尾删 删除尾结点（DoubleLList_TailDel）
  ...
  ![尾删](../img/文章/数据结构/数据结构三（双向链表DoubleLinkedList）/尾删.png "尾删")
