...
#sticky: 6              #置顶 越大越优先
cover: /img/封面/数据结构/cover (4).png   # 文章封面
---
##  前言
 ...
 ——遍历双向循环链表
  ...
  ![双向循环链表](../img/文章/数据结构/数据结构五（双向循环链表DoubleCirLList）/双向循环链表.png "双向循环链表")
...
##  头插（DoubleCirLList_HeadInsert）
  ...
  ![头插](../img/文章/数据结构/数据结构五（双向循环链表DoubleCirLList）/头插.png "头插")
...
##  尾插（DoubleCirLList_TailInsert）
  ...
  ![尾插](../img/文章/数据结构/数据结构五（双向循环链表DoubleCirLList）/尾插.png "尾插")
...
##  指定插入（DoubleCirLList_DestInsert）
  ...
  ![指定插入](../img/文章/数据结构/数据结构五（双向循环链表DoubleCirLList）/指定插入.png "指定插入")
...
##  头删 删除首结点（DoubleCirLList_HeadDel）
  ...
  ![头删](../img/文章/数据结构/数据结构五（双向循环链表DoubleCirLList）/头删.png "头删")
...
##  尾删 删除尾结点（DoubleCirLList_TailDel）
  ...
  ![尾删](../img/文章/数据结构/数据结构五（双向循环链表DoubleCirLList）/尾删.png "尾删")
